...
app = Flask(__name__, template_folder="templates") #Позже добавить jinja
app = Flask(__name__, static_folder="static")
t = Template("Name:{{mainTitle}}", "Summ:{{a+b}}")
t.render(name='Основная программа', a='2', b='3')
...
def get_users():
    ...
    for i in users:
        ...
        u += "<div class='block'>" + "<b>" + "<u>" + f"Пользователь {num}: " + "</u>" + "</b>" + "<br>" + user + "<br>" + "<br>" + "</div>" 
    return u, 200
...
def create_user():
    projectpath = request.form['regform']
